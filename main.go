...
import (
	...
	"dtweave.io/zookeeper-operator/controllers"
...
func init() {
	...
	utilruntime.Must(hadoopv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	options := ctrl.Options{
		...
		LeaderElectionID:       "aec1785b.dtweave.io",
	...
	if err = (&hadoopv1alpha1.Zookeeper{}).SetupWebhookWithManager(mgr); err != nil {
